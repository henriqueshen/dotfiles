  ...
  flake.nixvimModules.lsp = { pkgs, lib, ... }: {
    ...
    keymaps = [
      ...
      }
      {
        mode = "n";
        key = "<leader>lj";
        action = "function() vim.lsp.buf.typehierarchy('subtypes') end";
        lua = true;
        options = {
      ...
      }
      {
        mode = "n";
        key = "<leader>lk";
        action = "function() vim.lsp.buf.typehierarchy('supertypes') end";
        lua = true;
        options = {
      ...
      }
      {
        mode = "n";
        key = "<leader>lc";
        action = "function() vim.lsp.buf.incoming_calls() end";
        lua = true;
        options = {
